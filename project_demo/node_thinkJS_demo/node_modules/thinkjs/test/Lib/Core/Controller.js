...
describe('Controller', function(){
  ...
  it('instance.fetch("home:index:index")', function(done){
    var filepath = path.normalize(__dirname + '/../../App/View/Home/index_login.html');
  ...
  it('instance.fetch("Home/index_login.html")', function(done){
    promise.then(function(instance){
      instance.fetch('Home/index_login.html').then(function(content){
        assert.equal(content, 'hello, thinkjs!');
        done();
      })
    })
